...
@section('mainPart')
                ...
                <div class="col-md-10 row">
                    <div class="col-8 col-sm-8 mb-2 row">
                        <div class="col-4 col-md-2 mt-1 pl-0">
                            <img src="{{ asset(isset($admin->image) && file_exists($admin->image) ? $admin->image : 'image/dummy_user.jpg') }}" class="img-fluid rounded-circle ml-1 img-thumbnail" style="height: 65px;width:65px">
                        </div>
                        <div class="col-8 col-md-10 pl-0">
                            <h4 class="font-15 p-0 m-0 mt-1">
                                {{ $admin->name ?? "" }}
                            </h4>
                            <p class="font-13">
                                {{ $admin->group->name ?? "" }} 
    ...
    <div class="container-fluid bg-white mb-5" style="margin-top: -60px; position: relative;">
