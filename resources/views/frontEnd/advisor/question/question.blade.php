            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="form-group">
                        <label>Case Study Summary  <span class="text-danger">*</span> </label>
                        <input type="hidden" name="id" value="{{ isset($data->id) ? $data->id : 0 }}" >
                        <!--<textarea  name="question" class="form-control" value="{{ $data->question ?? Null }}"  required ></textarea>-->
                ...
                <div class="col-12 ">
                    <div class="form-group">
                        <label>Area of Advice <span class="text-danger">*</span> </label>
                        <select name="service_offer_id" class="form-control select2" required >
                            <option>Select Areas of Advice</option>
                ...
                <div class="col-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea rows="8" col="50" style="height: 150px;" name="answer" class="form-control editor">{{ $data->answer ?? null }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label>Case Study Visibility <span class="text-danger">*</span></label>
                        <select name="visibility" class="form-control" required >
                            ...
                            <option value="private" {{ isset($data->id) && $data->visibility == "private" ? 'selected' : Null }} >Private (appears anonymously only in the case studies page)</option>
                        </select>
                    </div>
                </div>
