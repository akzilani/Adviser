    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <p>
                    <strong>Primary Region </strong> : <br> {!! str_replace(',', ',<br>', $auction->primary_reason()) !!}
                </p>
                <p>
            ...
            <div class="col-12 col-sm-6">
                ...
                <p>
                    <strong>Areas of Advice </strong> : <br> {!! str_replace(',', ',<br>', $auction->service_offered()) !!}
                </p>
            </div>
        </div>
        <div class="row">    
        ...
        <div class="row">      
            ...
            <div class="col-12 col-sm-6">
                <p>
                    ...
                    @elseif( now() >= $auction->start_time && now() <= $auction->end_time )
            ...
            <div class="col-12 col-sm-6 col-md-5" align="center">
                <p>
